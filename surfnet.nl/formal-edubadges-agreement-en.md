...
We are glad that you’re reading the privacy statement of *surfnet.nl* for
...
*surfnet.nl* facilitates digital certificates for students.
...
*surfnet.nl* is the controller and SURF is the processor. This privacy
statement relates primarily to the processing by *surfnet.nl*.
...
*surfnet.nl* has access to your first name, last name and email address.
...
However, if you and *surfnet.nl* disagree and the response to your
