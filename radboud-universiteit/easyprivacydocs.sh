...
INSTITUTION_NAME_NL='Radboud Universiteit'          # e.g. Hogeschool SURF
INSTITUTION_NAME_EN='Radboud University'          # e.g. University of Applied Sciences SURF

# privacy contact is required
PRIVACY_CONTACT='mijnprivacy@ru.nl'              # e.g. privacy@hogeschoolsurf.nl
...
NONFORMAL_PURPOSE_NL='Het achterliggende doel van de Radboud Universiteit is om invulling te geven aan een "leven lang leren" en aan de "flexibilisering van het onderwijs". Door middel van de inzet van edubadges kunnen deze doelstellingen worden gerealiseerd.'
NONFORMAL_PURPOSE_EN='The underlying goal of Radboud University is to give substance to "lifelong learning" and to the "flexibilisation of education". These objectives can be achieved through the use of edubadges.'
FORMAL_PURPOSE_NL='Het achterliggende doel van de Radboud Universiteit is om invulling te geven aan een "leven lang leren" en aan de "flexibilisering van het onderwijs". Door middel van de inzet van edubadges kunnen deze doelstellingen worden gerealiseerd.'
FORMAL_PURPOSE_EN='The underlying goal of Radboud University is to give substance to "lifelong learning" and to the "flexibilisation of education". These objectives can be achieved through the use of edubadges.'

# the institution directory name on git must be set
INSTITUTION_DIRECTORY_NAME='radboud-universiteit'   # e.g. hogeschool-surf
