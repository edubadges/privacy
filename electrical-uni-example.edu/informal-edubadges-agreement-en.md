...
*electrical-uni-example.edu* facilitates digital certificates for student.
...
*electrical-uni-example.edu* has access to your first name, last name and email address. SURF and its management partner has access to all personal data. The personal data are not provided to other parties.\m
# 4 Security
