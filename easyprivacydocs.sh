...
################################################################################
# Version 1.4.0-RELEASE (26-04-2022)
################################################################################
...
TEXT_TABLE_NONFORMAL_PUBLIC_REQUEST_NL="\n\n| Persoonsgegeven | Doel | Grondslag |\n| --------------- | ---- | --------- |\n| eduID | Pseudonieme identifier in edubadge | Algemeen belang |\n| Voornaam | Identificatie van gebruiker | Publiek belang |\n| Achternaam | Identificatie van gebruiker | Publiek belang |\n| E-mailadres | Notificeren van gebruiker | Publiek belang |\n| Onderwijsinstelling | Afbakening beschikbare edubadges | Publiek belang |\n| Privacyinteractie | Of er akkoord is gegaan met Gebruiksvoorwaarden | Publiek belang |"
...
TEXT_TABLE_NONFORMAL_PUBLIC_AWARD_NL="\n\n| Persoonsgegeven | Doel | Grondslag |\n| --------------- | ---- | --------- |\n| eduID | Pseudonieme identifier in edubadge | Algemeen belang |\n| Voornaam | Identificatie van gebruiker | Publiek belang |\n| Achternaam | Identificatie van gebruiker | Publiek belang |\n| E-mailadres | Notificeren van gebruiker | Publiek belang |\n| Onderwijsinstelling | Afbakening beschikbare edubadges | Publiek belang |\n| Unieke identifier | Mogelijk maken om edubadges rechtstreeks aan de student toe te kennen | Publiek belang |\n| Privacyinteractie | Of er akkoord is gegaan met Gebruiksvoorwaarden | Publiek belang |"
