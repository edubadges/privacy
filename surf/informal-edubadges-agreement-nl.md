...
Voor beide onderdelen is SURF als werkgever de verwerkingsverantwoordelijke. Zie ook de [privacyverklaring van edubadges.nl](https://raw.githubusercontent.com/edubadges/privacy/master/surf/account-statement-nl.md). Vragen kun je stellen via een e-mail aan [support@edubadges.nl](mailto:support@edubadges.nl).
...
| Organisatie | Afbakening beschikbare edubadges | Uitvoering overeenkomst |
| Privacyinteractie | Of er akkoord is gegaan met Gebruiksvoorwaarden | Uitvoering overeenkomst |
| Resultaat | Een resultaat is optioneel | Uitvoering overeenkomst |
| Datum | Datum van uitgifte edubadge | Uitvoering overeenkomst |

Deze persoonsgegevens worden bewaard totdat de gebruiker de betreffende edubadge verwijderd + 1 maand vanwege back-ups. 

SURF en haar beheerpartner (Proxy Services B.V.) hebben toegang tot de verwerkte persoonsgegevens. De persoonsgegevens worden niet aan andere partijen verstrekt.

# 4 Beveiliging

De dienst edubadges volgt voor de beveiliging de Baseline Informatiebeveiliging SURF (BIS). De dienst gaat onder de ISO 27001-certificering vallen. Die bescherming omvat onder andere de volgende beveiligingsmaatregelen:
...
Je kunt je rechten uitoefenen conform het privacybeleid van SURF. Om deze rechten uit te oefenen of als je een klacht hebt, neem je contact op met [privacy@surf.nl](mailto@privacy@surf.nl).
