...
To receive this edubadge, you must agree with these terms of service. If you have any questions, comments or concerns, please email [edubadges@surf.nl](mailto:edubadges@surf.nl).
...
A technical infrastructure is required to create and award edubadges. SURF has developed the infrastructure for issuing edubadges and the edubadges are stored securely and can be validated within SURF's systems. More information about edubadges can be found on [SURF's website](https://surf.nl/edubadges).

# 2 Purpose and processing

SURF wants to provide employees with digital evidence by awarding edubadges. With edubadges, employees can demonstrate that they have certain skills and/or knowledge.
...
For both parts SURF is the controller. See the [privacy statement of edubadges.nl](https://raw.githubusercontent.com/edubadges/privacy/master/surf/account-statement-en.md) for more information. If you have questions you can contact [support@edubadges.nl](mailto:support@edubadges.nl).
...
| Organization | Demarcation of available edubadges | Performance of an agreement |
| Privacy interaction | Whether the privacy statement has been read | Performance of an agreement |
| Result | A result is optional | Performance of an agreement |
| Date | Date when the edubadge was issued | Performance of an agreement |

These personal data are processed until the user deletes the edubadge + 1 month because of backups.

SURF and her management partners (Proxy Services B.V.) have access to all personal data. The personal data are not provided to other parties.

# 4 Security

For security, the edubadges service follows the SURF Information Security Baseline (BIS). The service will fall under the ISO 27001 certification. This protection includes the following security measures:
...
You can exercise your rights in accordance with SURF's privacy policy. To exercise these rights or if you have a complaint, please contact [privacy@surf.nl](mailto:privacy@surf.nl). These rights are as follows:
