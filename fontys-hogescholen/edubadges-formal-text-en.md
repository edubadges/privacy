...
Fontys facilitates digital certificates for students.
...
Fontys has access to your first name, last name and email address. SURF and its management partner has access to all personal data. The personal data are not provided to other parties.
...
To exercise these rights, please contact [isp-office@fontys.nl](mailto:isp-office@fontys.nl).
