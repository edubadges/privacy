...
We are glad that you’re reading the privacy statement of *Harvard Example* for
...
*Harvard Example* facilitates digital certificates for students.
...
*Harvard Example* is the controller and SURF is the processor. This privacy
statement relates primarily to the processing by *Harvard Example*.
...
*Harvard Example* has access to your first name, last name and email address.
...
However, if you and *Harvard Example* disagree and the response to your
