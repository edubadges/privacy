...
INSTITUTION_NAME_NL='HAS green academy'          # e.g. Hogeschool SURF
INSTITUTION_NAME_EN='HAS green academy'          # e.g. University of Applied Sciences SURF

# privacy contact is required
PRIVACY_CONTACT='privacy@has.nl'              # e.g. privacy@hogeschoolsurf.nl
...
INSTITUTION_DIRECTORY_NAME='has-green-academy'   # e.g. hogeschool-surf
