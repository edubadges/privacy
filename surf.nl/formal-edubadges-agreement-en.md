...
We are glad that you’re reading the privacy statement of *surf.nl* for
...
*surf.nl* facilitates digital certificates for students.
...
*surf.nl* is the controller and SURF is the processor. This privacy
statement relates primarily to the processing by *surf.nl*.
...
*surf.nl* has access to your first name, last name and email address.
...
However, if you and *surf.nl* disagree and the response to your
